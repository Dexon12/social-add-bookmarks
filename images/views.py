...
def image_list(request):
    ...
    try:
        ...
        # If page not an integer give 1 page
        images = paginator.page(1)
    except EmptyPage:
        if images_only:
            # If AJAX-request and page out of range give empty page
            return HttpResponse('')
...
def image_ranking(request):
    ...
    return render(request, 'images/image/template/ranking.html', {'section': 'images', 'most_viewed': most_viewed})